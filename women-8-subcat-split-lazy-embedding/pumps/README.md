# Pumps — women, lazy embeddings

Women's size-8 **pumps**, analyzed as a standalone subcategory using the **lazy** embedding
...
|---|--:|:--:|
| **lazy (this folder)** | **−0.161** | yes |
| proper (re-trained) | −0.102 | yes |

Well-powered (626 training products). Both designs are significant and their 90% CIs overlap,
so lazy and proper agree here; lazy runs a touch more elastic. Pumps are among the **least**
price-elastic women's subcategories (fashion-sneakers are the most).
...
women's ASINs); they are filtered to pumps during the join in `01_1`/`01_2`. No per-subcategory
