...
def compute_neighbors_and_distances(embeddings, df_full, n_neighbors=5):
    ...
    # Reindex to embeddings' index so boolean mask aligns properly
    lagged_for_emb = lagged_quantities.reindex(embeddings.index)
    embeddings = embeddings.loc[lagged_for_emb.notna()]
